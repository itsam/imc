 ...
 */
class ImcViewKeys extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        $this->canManageKeys = $user->authorise('imc.manage.keys');
    ...
    protected function addToolbar() {
        if(!$this->canManageKeys){
            JToolBarHelper::title(JText::_('COM_IMC_TITLE_KEYS'), 'keys.png');
            //JToolBarHelper::back();
	...
	protected function getSortFields()
	{
		...
		'a.title' => JText::_('COM_IMC_KEYS_TITLE'),
		'a.skey' => JText::_('COM_IMC_KEYS_SKEY'),
		'a.ordering' => JText::_('JGRID_HEADING_ORDERING'),
		'a.state' => JText::_('JSTATUS'),
		'a.created_by' => JText::_('COM_IMC_KEYS_CREATED_BY'),
		);
	}
