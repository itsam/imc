 ...
 * key Table class
 */
class ImcTablekey extends JTable {
    ...
    public function __construct(&$db) {
        parent::__construct('#__imc_keys', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '') {
		...
		if(($task == 'save' || $task == 'apply') && (!JFactory::getUser()->authorise('core.edit.state','com_imc.key.'.$array['id']) && $array['state'] == 1)){
			$array['state'] = 0;
		}
