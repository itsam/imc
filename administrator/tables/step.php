 ...
 * step Table class
 */
class ImcTablestep extends JTable {
    ...
    public function __construct(&$db) {
        parent::__construct('#__imc_steps', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '') {
		...
		if(($task == 'save' || $task == 'apply') && (!JFactory::getUser()->authorise('core.edit.state','com_imc.step.'.$array['id']) && $array['state'] == 1)){
			$array['state'] = 0;
		}
    ...
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_imc.step.' . (int) $this->$k;
    }
